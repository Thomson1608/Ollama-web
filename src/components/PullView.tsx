        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {filteredModels.map(model => (
            <button
              ...
              className="p-5 rounded-3xl border bg-white border-gray-200 hover:border-blue-300 hover:shadow-md transition-all text-left group"
            >
              <div className="w-10 h-10 rounded-xl flex items-center justify-center transition-colors mb-4 bg-gray-50 group-hover:bg-blue-50 text-gray-400 group-hover:text-blue-500">
                <Cpu size={20} />
              </div>
